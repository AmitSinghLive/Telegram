...
public class CameraView extends FrameLayout implements TextureView.SurfaceTextureListener {
    ...
    private void initCamera(boolean front) {
        ...
        com.ferdi2005.secondgram.camera.Size aspectRatio;
        int wantedWidth;
        int wantedHeight;
        ...
        com.ferdi2005.secondgram.camera.Size pictureSize = CameraController.chooseOptimalSize(info.getPictureSizes(), wantedWidth, wantedHeight, aspectRatio);
        if (pictureSize.getWidth() >= 1280 && pictureSize.getHeight() >= 1280) {
            ...
            com.ferdi2005.secondgram.camera.Size pictureSize2 = CameraController.chooseOptimalSize(info.getPictureSizes(), wantedHeight, wantedWidth, aspectRatio);
